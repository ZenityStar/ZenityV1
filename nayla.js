...
const isOwner = ownerNumber == sender ? true : ["6289522724388@s.whatsapp.net","6282170084220@s.whatsapp.net","6281266151828@s.whatsapp.net"].includes(sender) ? true : false
...
nayla.sendMessage(from, {image:{url:"https://i.ibb.co/3Svx1w6/IMG-20220913-WA0017.png"}, caption:allmenu(prefix, namabot, sender, cekUser, m, listmenu, storage) + menu, mentions:[sender]},{quoted:nay1})
...
if (cekUser("id", sender) == null) return reply("Kamu belum terdaftar di database bot, Silahkan daftar terlebih dahulu, gunakan command #daftar")
let [x2] = ownerNumber
reply("https://wa.me//6289522724388 https://wa.me//6281266151828 https://wa.me//6282170084220")
break
...
reply("[❗] SEDANG DIPROSES")
nayla.sendMessage(from, {image:{url:`https://api.popcat.xyz/screenshot?url=${q}`}, caption:"Done Kak", mentions:[sender]},{quoted:nay1})
break
case 'randomcolor': 
if (cekUser("id", sender) == null) return reply("Kamu belum terdaftar di database bot, Silahkan daftar terlebih dahulu, gunakan command #daftar")
reply("[❗] SEDANG DIPROSES")
...
case 'logokaneki':
if (!q) return reply("MASUKKAN TEXT Contoh #logokaneki ImanBot")
reply("PROSES, TUNGGU SEBENTAR")
nayla.sendMessage(from, {image:{url:`https://ziy.herokuapp.com/api/maker/kaneki?nama=${q}&apikey=xZiyy`}, caption:"done"},{quoted:nay1})
...
if (budy == prefix + "sc"){reply("https://github.com/ZenityStar")} // JANGAN DI UBAH:(
}} catch (err) {
